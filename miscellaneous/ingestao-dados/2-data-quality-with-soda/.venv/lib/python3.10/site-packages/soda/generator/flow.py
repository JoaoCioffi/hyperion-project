...
class SuggestionFlow:
    def __init__(
        ...
        self.datasets_metadata = self._get_dataset_metadata(dataset_name=dataset_name)
        self.dataset_name = self._set_dataset_name(dataset_name)
        self.dataset_metadata: Dataset = self.datasets_metadata.datasets[self.dataset_name]
    ...
    def create_flow(self):
        selected_suggestions = SuggestionFilter(dataset_name=self.dataset_name).ask()
        ...
        for i, suggestion_key in enumerate(selected_suggestions):
            ...
            if suggestion_key == "freshness_check" or suggestion_key == "partition":
                ...
                suggestion_obj = suggestion_cls(dataset_name=self.dataset_name, scan=self.adaptor.scan)
            else:
                suggestion_obj = suggestion_cls(dataset_name=self.dataset_name)
    ...
    def _get_dataset_metadata(self, dataset_name=None) -> DatasetsMetadata:
