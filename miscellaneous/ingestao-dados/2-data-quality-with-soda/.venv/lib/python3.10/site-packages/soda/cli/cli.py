...
@click.group(help=f"Soda Library CLI version {SODA_LIBRARY_VERSION}, Soda Core CLI version {SODA_CORE_VERSION}")
def main():
    pass
...
def ingest(tool: str, data_source: str, configuration: str, verbose: bool | None, **kwargs):
    ...
    if tool == "dbt":
        try:
            ...
            scan._logs.error("Unable to import dbt module. Did you install `pip install soda-dbt`?")
    else:
