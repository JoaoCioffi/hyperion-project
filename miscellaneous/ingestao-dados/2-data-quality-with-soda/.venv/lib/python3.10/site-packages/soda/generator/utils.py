...
def get_event_tracker():
    # Don't move the import to the top of the file since the variables are overwritten in adaptor_factory.py
    from soda.generator.global_vars import SODA_ADAPTOR_NAME, SODA_API_KEY_ID

    event_tracker = EventTracker(
        soda_api_key_id=SODA_API_KEY_ID,
        invocation_id=str(uuid.uuid4()),
        adaptor_type=SODA_ADAPTOR_NAME,
    )
